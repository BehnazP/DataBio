function [info, precision, machineformat] = emihdrread(hdrfile)
...
%                lines: 749
%                bands: 3
%        header_offset: 4 x samples
%            file_type: 'emi Standard'
%            data_type: 4
%           interleave: 'bsq'
%          sensor_type: 'Unknown'
%           byte_order: 0
...
%
%   NOTE: This function is used by emiread to import data.
...
if ~isfield(info,'header_off_set')
    info.header_offset = 4 * info.samples;
end
